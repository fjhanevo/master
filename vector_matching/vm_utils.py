...
def vector_to_3D(vector: np.ndarray,reciprocal_radius: float, dtype=np.float32) -> np.ndarray:
    """
...
def apply_z_rotation(vector: np.ndarray,theta: float, dtype=np.float32) -> np.ndarray:
    """
...
def full_z_rotation(vector: np.ndarray, step_size: float, dtype=np.float32) -> np.ndarray:
    """
